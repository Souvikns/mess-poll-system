...
4. Click on the clone or download button on the forked repository. Make sure you are cloning your version. 
5. Proceed with any changes that you want make to the codebase as you feel. 
6. Comit those changes that you have made. 
...
Examples of behavior that contributes a positive enviorment include: 

* Using welcoming and inclusive language 
* Buing respectful of differing viewpoints and experience 
